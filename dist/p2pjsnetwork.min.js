...
"use strict";var e,r;Object.defineProperty(exports,"__esModule",{value:!0}),exports.NetworkMessageTypes=exports.ServerMessageTypes=void 0,function(e){e.Link="LINK",e.Offer="OFFER",e.Answer="ANSWER",e.Candidate="CANDIDATE",e.Complete="COMPLETE",e.EmptyServerError="EMPTY_SERVER_ERROR",e.WrongOrExpiredLinkError="WRONG_OR_EXPIRED_LINK_ERROR",e.WrongMessageFormatError="WRONG_MESSAGE_FORMAT_ERROR",e.WrongMessageTypeError="WRONG_MESSAGE_TYPE_ERROR",e.LinkAmountTooHighError="LINK_AMOUNT_TOO_HIGH_ERROR",e.MaxLinkAmountExceededError="MAX_LINK_AMOUNT_EXCEEDED_ERROR"}(e=exports.ServerMessageTypes||(exports.ServerMessageTypes={})),function(e){e.Broadcast="BROADCAST",e.Discover="DISCOVER",e.Offer="OFFER",e.Answer="ANSWER",e.Candidate="CANDIDATE"}(r=exports.NetworkMessageTypes||(exports.NetworkMessageTypes={}));
},{}],"WOs9":[function(require,module,exports) {
"use strict";var r=this&&this.__spreadArray||function(r,e){for(var o=0,t=e.length,n=r.length;o<t;o++,n++)r[n]=e[o];return r};Object.defineProperty(exports,"__esModule",{value:!0}),exports.LogLevel=void 0;var e,o="P2PJSNetwork: ";!function(r){r[r.Disabled=0]="Disabled",r[r.Errors=1]="Errors",r[r.Warnings=2]="Warnings",r[r.All=3]="All"}(e=exports.LogLevel||(exports.LogLevel={}));var t=function(){function t(){this.crrLogLevel=e.Disabled}return Object.defineProperty(t.prototype,"logLevel",{get:function(){return this.crrLogLevel},set:function(r){this.crrLogLevel=r},enumerable:!1,configurable:!0}),t.prototype.log=function(){for(var o=[],t=0;t<arguments.length;t++)o[t]=arguments[t];this.crrLogLevel>=e.All&&this.print.apply(this,r([e.All],o))},t.prototype.warn=function(){for(var o=[],t=0;t<arguments.length;t++)o[t]=arguments[t];this.crrLogLevel>=e.Warnings&&this.print.apply(this,r([e.Warnings],o))},t.prototype.error=function(){for(var o=[],t=0;t<arguments.length;t++)o[t]=arguments[t];this.crrLogLevel>=e.Errors&&this.print.apply(this,r([e.Errors],o))},t.prototype.setLogFunction=function(r){this.print=r},t.prototype.print=function(t){for(var n=[],l=1;l<arguments.length;l++)n[l-1]=arguments[l];var s=r([o],n);for(var i in s)s[i]instanceof Error&&(s[i]="("+s[i].name+") "+s[i].message);t>=e.All?console.log.apply(console,s):t>=e.Warnings?console.warn.apply(console,r(["WARNING"],s)):t>=e.Errors&&console.error.apply(console,r(["ERROR"],s))},t}();exports.default=new t;
...
},{"buffer":"dskh"}],"hgKi":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
...
},{"./dist/base64url":"oNlT"}],"UnXq":[function(require,module,exports) {
"use strict";var e=this&&this.__spreadArray||function(e,r){for(var t=0,n=r.length,o=e.length;t<n;t++,o++)e[o]=r[t];return e},r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.decodeTimespanedId=exports.randomTimespanedId=exports.randomId=void 0;var t=r(require("base64url")),n=function(r){var t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";return e([],Array(r)).map(function(){return t.charAt(Math.floor(Math.random()*t.length))}).join("")};exports.randomId=n;var o=function(e,r){return t.default.encode(JSON.stringify({salt:exports.randomId(e),ttl:Date.now()+1e3*r}))};exports.randomTimespanedId=o;var a=function(e){return JSON.parse(t.default.decode(e))};exports.decodeTimespanedId=a;
},{"base64url":"XVTP"}],"Hxpd":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])})(t,n)};return function(t,n){if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");function o(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(o.prototype=n.prototype,new o)}}(),t=this&&this.__assign||function(){return(t=Object.assign||function(e){for(var t,n=1,o=arguments.length;n<o;n++)for(var r in t=arguments[n])Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r]);return e}).apply(this,arguments)},n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var o=n(require("./logger")),r=require("events"),i=function(n){function r(e,o,r,i){var c=n.call(this)||this;return c.peerConnection=e,c.receiverSocket=o,c.transmitterSocket=r,c.peerConfiguration=t({},i),c.peerConnection.addEventListener("connectionstatechange",c.connectionStateHandler.bind(c)),c.receiverSocket.onmessage=function(e){return c.emit("message",JSON.parse(e.data),c)},c}return e(r,n),r.prototype.connectionStateHandler=function(){switch(this.peerConnection.iceConnectionState){case"failed":case"closed":case"disconnected":o.default.warn("Peer dsiconnected"),this.peerConnection.close(),this.emit("close",this);break;case"completed":o.default.log("Connection completed")}},r.prototype.sendTraced=function(e){this.transmitterSocket.send(JSON.stringify(e))},r.prototype.send=function(e,t){this.transmitterSocket.send(JSON.stringify({type:e,payload:t}))},r.prototype.close=function(){this.peerConnection.close(),this.receiverSocket.close(),this.transmitterSocket.close()},r}(r.EventEmitter);exports.default=i;
},{"./logger":"WOs9","events":"FRpO"}],"yXgN":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,n){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])})(t,n)};return function(t,n){if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");function r(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(r.prototype=n.prototype,new r)}}(),t=this&&this.__awaiter||function(e,t,n,r){return new(n||(n=Promise))(function(o,i){function c(e){try{a(r.next(e))}catch(t){i(t)}}function s(e){try{a(r.throw(e))}catch(t){i(t)}}function a(e){var t;e.done?o(e.value):(t=e.value,t instanceof n?t:new n(function(e){e(t)})).then(c,s)}a((r=r.apply(e,t||[])).next())})},n=this&&this.__generator||function(e,t){var n,r,o,i,c={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return i={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(i[Symbol.iterator]=function(){return this}),i;function s(i){return function(s){return function(i){if(n)throw new TypeError("Generator is already executing.");for(;c;)try{if(n=1,r&&(o=2&i[0]?r.return:i[0]?r.throw||((o=r.return)&&o.call(r),0):r.next)&&!(o=o.call(r,i[1])).done)return o;switch(r=0,o&&(i=[2&i[0],o.value]),i[0]){case 0:case 1:o=i;break;case 4:return c.label++,{value:i[1],done:!1};case 5:c.label++,r=i[1],i=[0];continue;case 7:i=c.ops.pop(),c.trys.pop();continue;default:if(!(o=(o=c.trys).length>0&&o[o.length-1])&&(6===i[0]||2===i[0])){c=0;continue}if(3===i[0]&&(!o||i[1]>o[0]&&i[1]<o[3])){c.label=i[1];break}if(6===i[0]&&c.label<o[1]){c.label=o[1],o=i;break}if(o&&c.label<o[2]){c.label=o[2],c.ops.push(i);break}o[2]&&c.ops.pop(),c.trys.pop();continue}i=t.call(e,c)}catch(s){i=[6,s],r=0}finally{n=o=0}if(5&i[0])throw i[1];return{value:i[0]?i[1]:void 0,done:!0}}([i,s])}}},r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var o=r(require("./peer")),i=require("events"),c=function(r){function i(e,t){var n=r.call(this)||this;return n.ttl=new Date,n.ttl.setMinutes(n.ttl.getMinutes()+1),n.peerConnection=new RTCPeerConnection(null==e?void 0:e.rtcConfiguration),n.receiverSocket=n.peerConnection.createDataChannel("receiver",t),n.peerConnection.addEventListener("datachannel",n.onCompleteConnection.bind(n)),n.peerConnection.addEventListener("icecandidate",n.onIceCandidate.bind(n)),n}return e(i,r),i.prototype.close=function(){this.peerConnection.close(),this.receiverSocket.close()},i.prototype.createOffer=function(){return t(this,void 0,Promise,function(){var e;return n(this,function(t){switch(t.label){case 0:return[4,this.peerConnection.createOffer()];case 1:return e=t.sent(),[4,this.peerConnection.setLocalDescription(e)];case 2:return t.sent(),[2,e]}})})},i.prototype.recceiveOffer=function(e){return t(this,void 0,Promise,function(){var t;return n(this,function(n){switch(n.label){case 0:return[4,this.peerConnection.setRemoteDescription(e)];case 1:return n.sent(),[4,this.peerConnection.createAnswer()];case 2:return t=n.sent(),[4,this.peerConnection.setLocalDescription(t)];case 3:return n.sent(),[2,t]}})})},i.prototype.recceiveAnswer=function(e){return t(this,void 0,Promise,function(){return n(this,function(t){switch(t.label){case 0:return[4,this.peerConnection.setRemoteDescription(e)];case 1:return t.sent(),[2]}})})},i.prototype.addCandidate=function(e){return t(this,void 0,Promise,function(){return n(this,function(t){switch(t.label){case 0:return[4,this.peerConnection.addIceCandidate(e)];case 1:return t.sent(),[2]}})})},i.prototype.onIceCandidate=function(e){this.emit("icecandidate",e.candidate)},i.prototype.onCompleteConnection=function(e){this.peerConnection.removeEventListener("datachannel",this.onCompleteConnection.bind(this)),this.peerConnection.removeEventListener("icecandidate",this.onIceCandidate.bind(this)),this.emit("completeConnection",new o.default(this.peerConnection,this.receiverSocket,e.channel))},i}(i.EventEmitter);exports.default=c;
},{"./peer":"Hxpd","events":"FRpO"}],"KsPy":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])})(t,r)};return function(t,r){if("function"!=typeof r&&null!==r)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}(),t=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(i,o){function a(e){try{l(n.next(e))}catch(t){o(t)}}function s(e){try{l(n.throw(e))}catch(t){o(t)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(a,s)}l((n=n.apply(e,t||[])).next())})},r=this&&this.__generator||function(e,t){var r,n,i,o,a={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return o={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o;function s(o){return function(s){return function(o){if(r)throw new TypeError("Generator is already executing.");for(;a;)try{if(r=1,n&&(i=2&o[0]?n.return:o[0]?n.throw||((i=n.return)&&i.call(n),0):n.next)&&!(i=i.call(n,o[1])).done)return i;switch(n=0,i&&(o=[2&o[0],i.value]),o[0]){case 0:case 1:i=o;break;case 4:return a.label++,{value:o[1],done:!1};case 5:a.label++,n=o[1],o=[0];continue;case 7:o=a.ops.pop(),a.trys.pop();continue;default:if(!(i=(i=a.trys).length>0&&i[i.length-1])&&(6===o[0]||2===o[0])){a=0;continue}if(3===o[0]&&(!i||o[1]>i[0]&&o[1]<i[3])){a.label=o[1];break}if(6===o[0]&&a.label<i[1]){a.label=i[1],i=o;break}if(i&&a.label<i[2]){a.label=i[2],a.ops.push(o);break}i[2]&&a.ops.pop(),a.trys.pop();continue}o=t.call(e,a)}catch(s){o=[6,s],n=0}finally{r=i=0}if(5&o[0])throw o[1];return{value:o[0]?o[1]:void 0,done:!0}}([o,s])}}},n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var i=n(require("./logger")),o=require("events"),a=n(require("./partialPeer")),s=require("lodash"),l=function(n){function o(e){var t=n.call(this)||this;return t.partialPeers={},t.peerConfiguration=e,t.startGarbageCollector(),t}return e(o,n),o.prototype.startGarbageCollector=function(){this.garbageCollectorInterval||(this.garbageCollectorInterval=setInterval(this.collectGarbage.bind(this),6e4))},o.prototype.collectGarbage=function(){for(var e in i.default.log("Collecting peerFactory garbage..."),this.partialPeers)new Date>this.partialPeers[e].ttl&&(this.partialPeers[e].close(),delete this.partialPeers[e],this.emit("expire",e));0===s.size(this.partialPeers)&&(clearInterval(this.garbageCollectorInterval),this.garbageCollectorInterval=void 0)},o.prototype.close=function(){for(var e in this.partialPeers)this.partialPeers[e].close(),delete this.partialPeers[e]},o.prototype.createOffer=function(e){return t(this,void 0,void 0,function(){var t;return r(this,function(r){switch(r.label){case 0:return t=new a.default(this.peerConfiguration),this.onEvents(t,e),this.partialPeers[e]=t,this.startGarbageCollector(),[4,t.createOffer()];case 1:return[2,r.sent()]}})})},o.prototype.recceiveOffer=function(e){return t(this,void 0,Promise,function(){var t;return r(this,function(r){switch(r.label){case 0:return t=new a.default(this.peerConfiguration),this.onEvents(t,e.linkId),this.partialPeers[e.linkId]=t,this.startGarbageCollector(),[4,t.recceiveOffer(e.offer)];case 1:return[2,r.sent()]}})})},o.prototype.receiveAnswer=function(e){return t(this,void 0,Promise,function(){return r(this,function(t){switch(t.label){case 0:return e.linkId in this.partialPeers?[4,this.partialPeers[e.linkId].recceiveAnswer(e.answer)]:[3,2];case 1:return t.sent(),[3,3];case 2:i.default.error("Answer recceived in unknown link id"),t.label=3;case 3:return[2]}})})},o.prototype.recceiveCandidate=function(e){return t(this,void 0,Promise,function(){return r(this,function(t){switch(t.label){case 0:return e.linkId in this.partialPeers?[4,this.partialPeers[e.linkId].addCandidate(e.candidate)]:[3,2];case 1:return t.sent(),[3,3];case 2:i.default.error("Candidate recceived in unknown link id"),t.label=3;case 3:return[2]}})})},o.prototype.onEvents=function(e,t){var r=this;e.on("icecandidate",function(e){r.emit("icecandidate",t,e)}),e.on("completeConnection",function(n){e.removeAllListeners(),delete r.partialPeers[t],r.emit("connection",t,n)})},o}(o.EventEmitter);exports.default=l;
},{"./logger":"WOs9","events":"FRpO","./partialPeer":"yXgN","lodash":"B1iE"}],"PuRK":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])})(t,r)};return function(t,r){if("function"!=typeof r&&null!==r)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");function o(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(o.prototype=r.prototype,new o)}}(),t=this&&this.__assign||function(){return(t=Object.assign||function(e){for(var t,r=1,o=arguments.length;r<o;r++)for(var a in t=arguments[r])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)},r=this&&this.__createBinding||(Object.create?function(e,t,r,o){void 0===o&&(o=r),Object.defineProperty(e,o,{enumerable:!0,get:function(){return t[r]}})}:function(e,t,r,o){void 0===o&&(o=r),e[o]=t[r]}),o=this&&this.__setModuleDefault||(Object.create?function(e,t){Object.defineProperty(e,"default",{enumerable:!0,value:t})}:function(e,t){e.default=t}),a=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var a in e)"default"!==a&&Object.prototype.hasOwnProperty.call(e,a)&&r(t,e,a);return o(t,e),t},n=this&&this.__spreadArray||function(e,t){for(var r=0,o=t.length,a=e.length;r<o;r++,a++)e[a]=t[r];return e},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var s=require("events"),c=require("./enums"),d=a(require("./logger")),l=require("lodash"),p=require("./utils"),u=i(require("./peerFactory")),f=i(require("./logger")),h=function(r){function o(e,o){var a=r.call(this)||this;return a.peers={},a.candidates={},a.receivedIds={},a.networkConfig=t({logLevel:d.LogLevel.Disabled,garbageCollectorInterval:6e4,idSaltLength:8,messageLifespan:300,maxPeerCount:15,targetPeerCount:7,minPeerCount:3,avgOdds:.7,defaltDiscoverTargetDepth:3},e),d.default.logLevel=a.networkConfig.logLevel,a.peerFactory=new u.default(o),a.peerFactory.on("icecandidate",a.onPeerIceCandidate.bind(a)),a.peerFactory.on("connection",a.onPeerConnection.bind(a)),a.startGarbageCollector(),a}return e(o,r),Object.defineProperty(o.prototype,"availablePeers",{get:function(){return Object.values(this.peers)},enumerable:!1,configurable:!0}),o.prototype.startGarbageCollector=function(){this.garbageCollectorInterval||(this.garbageCollectorInterval=setInterval(this.collectGarbage.bind(this),this.networkConfig.garbageCollectorInterval))},o.prototype.collectGarbage=function(){var e=this;d.default.log("Collecting garbage..."),Object.entries(this.receivedIds).forEach(function(t){var r=t[0],o=t[1];new Date>new Date(o.ttl)&&(d.default.log("Garbage id{"+r+"} collected"),delete e.receivedIds[r])}),0===l.size(this.receivedIds)&&(clearInterval(this.garbageCollectorInterval),this.garbageCollectorInterval=void 0)},o.prototype.addReceivedId=function(e){this.receivedIds[e]=p.decodeTimespanedId(e),this.startGarbageCollector()},o.prototype.onPeerConnection=function(e,t){delete this.candidates[e],this.addPeer(e,t)},o.prototype.onPeerIceCandidate=function(e,t){d.default.log("Peer candidate recceived."),this.IceCandidate(e,t)},o.prototype.broadcastMessage=function(e){Object.entries(this.peers).forEach(function(t){t[0];t[1].sendTraced(e)})},o.prototype.routeMessage=function(e){var r=e.routeStack.pop();r in this.peers&&(d.default.log("Routing message to "+r),this.peers[r].sendTraced(t(t({},e),{traceStack:n(n([],e.traceStack),[r])})))},o.prototype.offer=function(e){var t=this,r=e.pop();if(r in this.peers){d.default.log("Performing Offer to node "+r);var o=Math.random().toString(36).substr(2);this.candidates[o]=n(n([],e),[r]),this.peerFactory.createOffer(o).then(function(a){t.peers[r].sendTraced({id:p.randomTimespanedId(t.networkConfig.idSaltLength,t.networkConfig.messageLifespan),type:c.NetworkMessageTypes.Offer,routeStack:e,traceStack:[r],payload:{linkId:o,offer:a}})})}},o.prototype.answer=function(e){var t=this,r=e.traceStack.pop();this.peerFactory.recceiveOffer(e.payload).then(function(o){d.default.log("Performing Answer to node "+e.payload.linkId),t.candidates[e.payload.linkId]=e.traceStack,t.peers[r].sendTraced({id:p.randomTimespanedId(t.networkConfig.idSaltLength,t.networkConfig.messageLifespan),type:c.NetworkMessageTypes.Answer,routeStack:e.traceStack,traceStack:[r],payload:{linkId:e.payload.linkId,answer:o}})})},o.prototype.IceCandidate=function(e,t){if(e in this.candidates){var r=this.candidates[e],o=r.pop();o in this.peers&&(d.default.log("Send IceCandidate to node "+o),this.peers[o].sendTraced({id:p.randomTimespanedId(this.networkConfig.idSaltLength,this.networkConfig.messageLifespan),type:c.NetworkMessageTypes.Candidate,routeStack:r,traceStack:[o],payload:{linkId:e,candidate:t}}))}},o.prototype.performDiscover=function(e,r,o){var a=l.sampleSize(e,o.amount);a.forEach(function(e,i){var s=e[0],l=e[1];d.default.log("Performing Discover in node "+s),l.sendTraced({id:r,type:c.NetworkMessageTypes.Discover,payload:t(t({},o),{routeStack:n(n([],o.routeStack),[s]),amount:Math.floor(o.amount/a.length)+o.amount%a.length*Math.pow(0,i)})})})},o.prototype.connectionClosed=function(e,t){delete this.peers[e];var r=l.size(this.peers);d.default.log(r+" peers connected"),r<=this.networkConfig.minPeerCount&&this.discover(this.networkConfig.targetPeerCount-r),this.emit("close",e,t)},o.prototype.handleMessage=function(e,t){var r=t[0];t[1];switch(e.type){case c.NetworkMessageTypes.Broadcast:e.id in this.receivedIds||(this.addReceivedId(e.id),this.broadcastMessage(e),this.emit("message",e.payload));break;case c.NetworkMessageTypes.Discover:if(!(e.id in this.receivedIds)){this.addReceivedId(e.id);var o=e.payload,a=Object.entries(this.peers).filter(function(e){return e[0]!==l.last(o.routeStack)});if(o.routeStack.length>=o.targetDepth&&a.length<this.networkConfig.maxPeerCount)this.offer(o.routeStack);else{var n=!0;if(o.routeStack.length>1){var i=a.reduce(function(e,t){var r=t[0];return e||o.routeStack.includes(r)},!1),s=a.reduce(function(e,t){var r=t[0];return e||o.exceptions.includes(r)},!1);n=!i&&!s}n&&this.performDiscover(a,e.id,o)}}break;case c.NetworkMessageTypes.Offer:(d=e).routeStack.length>0?this.routeMessage(d):this.answer(d);break;case c.NetworkMessageTypes.Answer:(d=e).routeStack.length>0?this.routeMessage(d):(f.default.log("Answer Recceived from "+r),this.peerFactory.receiveAnswer(e.payload));break;case c.NetworkMessageTypes.Candidate:var d;(d=e).routeStack.length>0?this.routeMessage(d):this.peerFactory.recceiveCandidate(e.payload);break;default:this.emit("message",e)}},o.prototype.close=function(){Object.entries(this.peers).forEach(function(e){e[0];e[1].close()}),clearInterval(this.garbageCollectorInterval)},o.prototype.addPeer=function(e,t){var r=this;this.peers[e]=t,d.default.log("Peer "+e+" connected - "+l.size(this.peers)),this.emit("connection",e,t),t.on("message",function(t,o){return r.handleMessage(t,[e,o])}),t.on("close",function(t){return r.connectionClosed(e,t)})},o.prototype.broadcast=function(e,t){var r={type:c.NetworkMessageTypes.Broadcast,payload:{type:e,payload:t},id:p.randomTimespanedId(this.networkConfig.idSaltLength,this.networkConfig.messageLifespan)};this.addReceivedId(r.id),this.broadcastMessage(r)},o.prototype.discover=function(e,t){this.performDiscover(Object.entries(this.peers),p.randomTimespanedId(this.networkConfig.idSaltLength,this.networkConfig.messageLifespan),{exceptions:Object.keys(this.peers),routeStack:[],targetDepth:null!=t?t:this.networkConfig.defaltDiscoverTargetDepth,amount:e})},o}(s.EventEmitter);exports.default=h;
},{"events":"FRpO","./enums":"ZRYf","./logger":"WOs9","lodash":"B1iE","./utils":"UnXq","./peerFactory":"KsPy"}],"Scr6":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=function(r,t){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t])})(r,t)};return function(r,t){if("function"!=typeof t&&null!==t)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");function o(){this.constructor=r}e(r,t),r.prototype=null===t?Object.create(t):(o.prototype=t.prototype,new o)}}(),r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t=r(require("./logger")),o=r(require("./peerFactory")),n=require("./enums"),s=require("events"),a=r(require("./network")),i=function(r){function s(e,n,s){var i,c,p=r.call(this)||this,d=e.secure?"wss://":"ws://",l=null!==(c=null===(i=e.params)||void 0===i?void 0:i.map(function(e){return e[0]+"="+e[1]}).join("&"))&&void 0!==c?c:"",u=""+d+e.path+":"+e.port+"?"+l;return t.default.log("Opening discover server socket."),p.webSocket=new WebSocket(u),p.webSocket.onopen=p.onConnectionOpen.bind(p),p.webSocket.onclose=p.onConnectionClose.bind(p),p.webSocket.onmessage=function(e){p.handleMessage(JSON.parse(e.data))},p.peerFactory=new o.default(s),p.peerFactory.on("icecandidate",p.onPeerIceCandidate.bind(p)),p.peerFactory.on("connection",p.onPeerConnection.bind(p)),p.network=new a.default(n,s),p}return e(s,r),s.prototype.discover=function(e){return t.default.log("Starting peer search."),this.send(n.ServerMessageTypes.Link,{amount:e}),this.network},s.prototype.close=function(){this.webSocket.close(),this.peerFactory.close()},s.prototype.onPeerConnection=function(e,r){this.send(n.ServerMessageTypes.Complete,{linkId:e}),this.network.addPeer(e,r)},s.prototype.onPeerIceCandidate=function(e,r){t.default.log("Peer candidate recceived."),this.send(n.ServerMessageTypes.Candidate,{linkId:e,candidate:r})},s.prototype.onConnectionOpen=function(){t.default.log("Link server socket opened."),this.emit("open")},s.prototype.onConnectionClose=function(){t.default.log("Link server socket closed.")},s.prototype.send=function(e,r){this.webSocket.send(JSON.stringify({type:e,payload:r}))},s.prototype.handleMessage=function(e){var r=this;switch(e.type){case n.ServerMessageTypes.Link:var o=e.payload.links;t.default.log(o.length+" links found"),t.default.log("Starting connections..."),o.forEach(function(e){r.peerFactory.createOffer(e).then(function(t){r.send(n.ServerMessageTypes.Offer,{linkId:e,offer:t})})});break;case n.ServerMessageTypes.Offer:t.default.log("Offer recceived."),this.peerFactory.recceiveOffer(e.payload).then(function(t){r.send(n.ServerMessageTypes.Answer,{answer:t,linkId:e.payload.linkId})});break;case n.ServerMessageTypes.Answer:this.peerFactory.receiveAnswer(e.payload);break;case n.ServerMessageTypes.Candidate:this.peerFactory.recceiveCandidate(e.payload);break;case n.ServerMessageTypes.EmptyServerError:t.default.warn(e.payload.message),this.emit("emptylinkserver");break;case n.ServerMessageTypes.LinkAmountTooHighError:case n.ServerMessageTypes.MaxLinkAmountExceededError:t.default.error(e.payload.message),this.emit("configurationError",e);break;case n.ServerMessageTypes.WrongMessageTypeError:case n.ServerMessageTypes.WrongOrExpiredLinkError:case n.ServerMessageTypes.WrongMessageFormatError:t.default.error(e.payload.message),this.emit("communicationError",e)}},s}(s.EventEmitter);exports.default=i;
},{"./logger":"WOs9","./peerFactory":"KsPy","./enums":"ZRYf","events":"FRpO","./network":"PuRK"}],"iTK6":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.LogLevel=exports.p2pjsnetwork=void 0;var r=e(require("./network")),t=require("./logger"),o=e(require("./discoveryClient"));exports.p2pjsnetwork={DiscoveryClient:o.default,Network:r.default,LogLevel:t.LogLevel};var l=require("./logger");Object.defineProperty(exports,"LogLevel",{enumerable:!0,get:function(){return l.LogLevel}}),exports.default=o.default,window.p2pjsnetwork=exports.p2pjsnetwork;
},{"./network":"PuRK","./logger":"WOs9","./discoveryClient":"Scr6"}]},{},["iTK6"], null)
//# sourceMappingURL=/p2pjsnetwork.min.js.map